...
Module PartialHoareLogicRules (HD: HoareLogicDefs).
  ...
  Qed.
  Arguments synt_wp_if {_ _ _ _ _}.
  ...
  Qed.
  Arguments wp_if {_ _ _ _ _}.


  Lemma synt_wp_seq:
    forall (p q: ImpProg) (pre post mid: Pred),
